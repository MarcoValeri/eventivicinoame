...
func AdminEventAdd(w http.ResponseWriter, r *http.Request) {
...
func AdminEventEdit(w http.ResponseWriter, r *http.Request) {
...
func AdminEventDelete(w http.ResponseWriter, r *http.Request) {
...
func AdminEventsSearch(w http.ResponseWriter, r *http.Request) {
